...
import com.example.imgstreamproject.view.TextAlignment;
...
public class ExpandableTextView extends ConstraintLayout implements View.OnClickListener {
    ...
    private void init() {
        ...
        tvText = rootView.findViewById(R.id.tv_custom_view_expandable_text_view_text);

        ivIcon = rootView.findViewById(R.id.custom_view_expandable_text_view_icon);
